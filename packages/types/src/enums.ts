...
export type BookingStatus =
  ...
  | 'cancelled'
  | 'disputed'
// Caster platform subscription state — mirrors Stripe subscription statuses.
...
// The kind of work a portfolio entry represents (media type stays PortfolioItemType).
export type PortfolioEntryType =
  ...
  | 'commercial'
  | 'other'
// Professional / social link platforms an artist can attach to their profile.
