      ...
      <main className="bg-background">
        ...
        <section className="w-full py-24 lg:py-32">
          <div className="mx-auto w-full max-w-[90rem] px-6 lg:px-8">
            <Reveal>
              <div className="max-w-3xl">
                ...
                <h2 className="mt-6 text-balance text-4xl font-medium leading-[1.05] tracking-[-0.02em] text-foreground sm:text-5xl">
                  ...
                  <span className="font-serif font-normal italic">the shoot does.</span>
                </h2>
                <p className="mt-6 text-lg leading-relaxed text-foreground/75">
                  Stripe holds the caster&apos;s payment from booking confirmation through shoot
                  completion. Auto-release at +48 hours stops payouts from getting stuck if a caster
                  goes quiet.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={120}>
              <ol className="mt-16 grid gap-4 lg:grid-cols-4">
