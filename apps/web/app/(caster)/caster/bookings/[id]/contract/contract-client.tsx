...
export function ContractClient({ bookingId }: { bookingId: string }) {
  ...
  const alreadySigned = contract.casterSigned
        ...
        <div className="space-y-4">
          <Card className="space-y-4 p-6">
            ...
            <ul className="space-y-3 text-sm">
              ...
              />
              <SignatureRow
                label={contract.artistLegalName}
          ...
          <Card className="space-y-4 p-6">
            ...
            {alreadySigned ? (
              <div className="flex items-start gap-2 rounded-lg border border-emerald-200 bg-emerald-50 p-3 text-sm text-emerald-700">
                ...
                You signed this contract on {formatDate(contract.casterSignedAt)}.
              </div>
            ) : isVoided ? (
              ...
              <>
                <p className="text-xs text-muted-foreground">
                  By typing your company’s legal name below and submitting, you are providing a
                  legally binding electronic signature under the Electronic Communications Act 2000.
                </p>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder={`e.g. ${contract.casterCompanyName}`}
                    maxLength={200}
                ...
                <label className="flex items-start gap-2 text-sm text-foreground">
                  ...
                  />
                  <span>I agree to the terms of this contract on behalf of my company.</span>
                </label>
