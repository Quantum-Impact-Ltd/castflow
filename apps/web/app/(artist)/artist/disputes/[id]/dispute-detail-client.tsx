...
import { PageHeader, LoadingState, ErrorState, EmptyState, StatusBadge } from '@/components/dashboard'
          ...
          <EmptyState
            ...
            action={
              <Button asChild size="sm" variant="outline">
                <Link href={`/artist/bookings/${bookingId}`}>Back to booking</Link>
              </Button>
            }
          />
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <Button asChild variant="outline">
        <Link href={`/artist/bookings/${bookingId}`}>View booking</Link>
      </Button>
    </div>
  )
}
